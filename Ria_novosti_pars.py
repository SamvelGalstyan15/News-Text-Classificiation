...
# req = requests.get('https://ria.ru/economy/', headers=headers)
# soup = BeautifulSoup(req.text, features="lxml")

# links = soup.select("a[href*='ria.ru']")

# all_links = []
# for i in links:
#     link = i.get('href')
#     if link and 'ria.ru' in link and link.endswith('.html'):
