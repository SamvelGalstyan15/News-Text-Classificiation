 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 1,
   "id": "a8e225ed-d254-4b00-a450-ab22c1922cff",
   "metadata": {},
   "outputs": [],
   "source": [
    "import numpy as np\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 2,
   "id": "4f9c2244-4069-4fcb-8a21-a4bd7dee7463",
   "metadata": {},
   "outputs": [],
   "source": [
    "df_train_ria = pd.read_csv('../../selenium/news_pars/Ria_pars.csv')\n",
    "df_train_lenta = pd.read_csv('../../selenium/news_pars/LentaRu_pars.csv')\n",
    "df_test = pd.read_csv('test_news.csv')\n",
    "df_sub = pd.read_csv('base_submission_news.csv')"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 3,
   "id": "2a25c2c9-6b27-4775-89c9-eb16d3dd00fb",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 4,
   "id": "dfed415d-093c-44e2-b65c-b6d18291241a",
   "metadata": {},
   "outputs": [],
   "source": [
    "def clean_text(text):\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 5,
   "id": "bb4f55af-c69f-4ba3-87f0-abba2451051c",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 6,
   "id": "f7574547-d7b8-4136-8be1-159fa4479ded",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 7,
   "id": "b06274a9-ac90-4bf4-a58d-c9e7a4131b9e",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 8,
   "id": "7669753b-b294-4970-9d27-de078cd1bb2d",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 9,
   "id": "f0a46d89-2eb9-483f-a88d-499d1eb7b3f2",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 10,
   "id": "9f5d8a50-fc35-49aa-804a-a4975a09081e",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
     ...
     "text": [
      ...
      "wellness [('словам', 104), ('может', 82), ('ранее', 81), ('также', 67), ('после', 62), ('чтобы', 53), ('когда', 50), ('время', 49), ('которые', 47), ('только', 44)]\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 11,
   "id": "3c9f7a26-9130-4e70-af71-d6cf99b8ca07",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 12,
   "id": "eb435382-840b-4686-9a2c-6ade8ea30d2d",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 13,
   "id": "5b58e2a5-79f6-40a0-99e8-acd8e08e1acf",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 14,
   "id": "404d2bed-7b8b-4a8e-b5fa-6215a04c390b",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 15,
   "id": "1b749cf2-1f2a-45ad-875a-b82d3336e053",
   "metadata": {},
   "outputs": [
    {
     "data": {
      "text/html": [
       ...
       "    <tr>\n",
       "      <th>0</th>\n",
       "      <td>фото фонтанка ру поделитьсяэкс министру оборон...</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>1</th>\n",
       "      <td>в начале пушкинском районе санкт петербурга вв...</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>2</th>\n",
       ...
       "    <tr>\n",
       "      <th>3</th>\n",
       "      <td>если вы хотели но так съездили море летом чита...</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>4</th>\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 16,
   "id": "b87dbcee-daa6-4f16-ac10-61596ff37aef",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 17,
   "id": "75bc0804-efee-4113-8aad-b333b3a4f156",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 18,
   "id": "3fea95e0-db19-4703-b030-67ebb4d171dd",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 19,
   "id": "aafc9f97-daab-4de4-a518-34ee5de522b7",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 20,
   "id": "4dcdf785-48c9-4066-a88e-0456dd0158b5",
   "metadata": {},
   "outputs": [],
   "source": [
    "# df_train.loc[df_train['Category'] == 'wellness', 'Category'] = 5"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 21,
   "id": "3493f4ef-571c-4a1d-ba4e-bcd6957664d5",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 22,
   "id": "5e9311b3-8632-4933-8c7d-9ddfa19c48eb",
   "metadata": {},
   "outputs": [],
   "source": [
    "# df_train.loc[df_train['Category'] == 'science', 'Category'] = 8"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 23,
   "id": "680088c5-fbf1-4cfd-b833-cfe36b78da9d",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 24,
   "id": "6f369956-6022-42d3-89aa-5b1043324d96",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 25,
   "id": "88bfd4f8-a182-4ddd-8ffc-0df22e3dcc33",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 26,
   "id": "b6a9a8c0-4344-4741-a896-ad3d9d7696c8",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 27,
   "id": "f8eef0f1-7958-4007-80d8-45cbbff6a1ee",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 28,
   "id": "2f1a165e-7036-47f5-a83c-eed85e182318",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "id": "98f31d51-eeb7-4b66-b660-f80033073ede",
   "metadata": {},
   "outputs": [],
   "source": [
    "from transformers import AutoTokenizer, AutoModel\n",
    "\n",
    "# Выбираем модель (например, легкую версию RuBERT)\n",
    "model_name = \"cointegrated/rubert-tiny2\"\n",
    "\n",
    "# Импортируем и загружаем\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 198,
   "id": "7fa8eef6-7ff5-4d90-9c64-11a0f1ec3fc1",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 199,
   "id": "35540ab7-4fe0-4c0a-afab-56dab2133f28",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 205,
   "id": "ceb1ea4e-b412-4514-ac47-0c2fa5581460",
   "metadata": {},
   "outputs": [],
   "source": [
    "params = {\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 206,
   "id": "1c196ee6-d024-4a94-bc3d-c65d12695922",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 207,
   "id": "5fed1012-e783-421c-b013-964f32ff69aa",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
     ...
     "text": [
      ...
      "[CV] END model__criterion=gini, model__max_depth=14, model__n_estimators=100; total time=   1.0s\n",
      "[CV] END model__criterion=gini, model__max_depth=14, model__n_estimators=100; total time=   0.9s\n",
      "[CV] END model__criterion=gini, model__max_depth=14, model__n_estimators=100; total time=   0.9s\n",
      "[CV] END model__criterion=gini, model__max_depth=14, model__n_estimators=120; total time=   1.1s\n",
      "[CV] END model__criterion=gini, model__max_depth=14, model__n_estimators=120; total time=   1.0s\n",
      "[CV] END model__criterion=gini, model__max_depth=14, model__n_estimators=120; total time=   1.0s\n",
      "[CV] END model__criterion=gini, model__max_depth=14, model__n_estimators=140; total time=   1.2s\n",
      "[CV] END model__criterion=gini, model__max_depth=14, model__n_estimators=140; total time=   1.2s\n",
      "[CV] END model__criterion=gini, model__max_depth=14, model__n_estimators=140; total time=   1.2s\n",
      "[CV] END model__criterion=gini, model__max_depth=16, model__n_estimators=100; total time=   1.0s\n",
      "[CV] END model__criterion=gini, model__max_depth=16, model__n_estimators=100; total time=   0.9s\n",
      "[CV] END model__criterion=gini, model__max_depth=16, model__n_estimators=100; total time=   0.9s\n",
      "[CV] END model__criterion=gini, model__max_depth=16, model__n_estimators=120; total time=   1.1s\n",
      "[CV] END model__criterion=gini, model__max_depth=16, model__n_estimators=120; total time=   1.1s\n",
      "[CV] END model__criterion=gini, model__max_depth=16, model__n_estimators=120; total time=   1.1s\n",
      "[CV] END model__criterion=gini, model__max_depth=16, model__n_estimators=140; total time=   1.3s\n",
      "[CV] END model__criterion=gini, model__max_depth=16, model__n_estimators=140; total time=   1.3s\n",
      "[CV] END model__criterion=gini, model__max_depth=16, model__n_estimators=140; total time=   1.2s\n",
      "[CV] END model__criterion=gini, model__max_depth=18, model__n_estimators=100; total time=   1.1s\n",
      "[CV] END model__criterion=gini, model__max_depth=18, model__n_estimators=100; total time=   1.0s\n",
      "[CV] END model__criterion=gini, model__max_depth=18, model__n_estimators=100; total time=   1.0s\n",
      "[CV] END model__criterion=gini, model__max_depth=18, model__n_estimators=120; total time=   1.2s\n",
      "[CV] END model__criterion=gini, model__max_depth=18, model__n_estimators=120; total time=   1.2s\n",
      "[CV] END model__criterion=gini, model__max_depth=18, model__n_estimators=120; total time=   1.5s\n",
      "[CV] END model__criterion=gini, model__max_depth=18, model__n_estimators=140; total time=   1.4s\n",
      "[CV] END model__criterion=gini, model__max_depth=18, model__n_estimators=140; total time=   1.3s\n",
      "[CV] END model__criterion=gini, model__max_depth=18, model__n_estimators=140; total time=   1.3s\n",
      "[CV] END model__criterion=entropy, model__max_depth=14, model__n_estimators=100; total time=   1.1s\n",
      "[CV] END model__criterion=entropy, model__max_depth=14, model__n_estimators=100; total time=   1.0s\n",
      "[CV] END model__criterion=entropy, model__max_depth=14, model__n_estimators=100; total time=   1.0s\n",
      "[CV] END model__criterion=entropy, model__max_depth=14, model__n_estimators=120; total time=   1.4s\n",
      "[CV] END model__criterion=entropy, model__max_depth=14, model__n_estimators=120; total time=   1.2s\n",
      "[CV] END model__criterion=entropy, model__max_depth=14, model__n_estimators=120; total time=   1.4s\n",
      "[CV] END model__criterion=entropy, model__max_depth=14, model__n_estimators=140; total time=   1.5s\n",
      "[CV] END model__criterion=entropy, model__max_depth=14, model__n_estimators=140; total time=   1.4s\n",
      "[CV] END model__criterion=entropy, model__max_depth=14, model__n_estimators=140; total time=   1.3s\n",
      "[CV] END model__criterion=entropy, model__max_depth=16, model__n_estimators=100; total time=   1.2s\n",
      "[CV] END model__criterion=entropy, model__max_depth=16, model__n_estimators=100; total time=   1.1s\n",
      "[CV] END model__criterion=entropy, model__max_depth=16, model__n_estimators=100; total time=   1.1s\n",
      "[CV] END model__criterion=entropy, model__max_depth=16, model__n_estimators=120; total time=   1.3s\n",
      "[CV] END model__criterion=entropy, model__max_depth=16, model__n_estimators=120; total time=   1.3s\n",
      "[CV] END model__criterion=entropy, model__max_depth=16, model__n_estimators=120; total time=   1.3s\n",
      "[CV] END model__criterion=entropy, model__max_depth=16, model__n_estimators=140; total time=   1.5s\n",
      "[CV] END model__criterion=entropy, model__max_depth=16, model__n_estimators=140; total time=   1.5s\n",
      "[CV] END model__criterion=entropy, model__max_depth=16, model__n_estimators=140; total time=   1.5s\n",
      "[CV] END model__criterion=entropy, model__max_depth=18, model__n_estimators=100; total time=   1.3s\n",
      "[CV] END model__criterion=entropy, model__max_depth=18, model__n_estimators=100; total time=   1.2s\n",
      "[CV] END model__criterion=entropy, model__max_depth=18, model__n_estimators=100; total time=   1.2s\n",
      "[CV] END model__criterion=entropy, model__max_depth=18, model__n_estimators=120; total time=   1.4s\n",
      "[CV] END model__criterion=entropy, model__max_depth=18, model__n_estimators=120; total time=   1.3s\n",
      "[CV] END model__criterion=entropy, model__max_depth=18, model__n_estimators=120; total time=   1.4s\n",
      "[CV] END model__criterion=entropy, model__max_depth=18, model__n_estimators=140; total time=   1.6s\n",
      "[CV] END model__criterion=entropy, model__max_depth=18, model__n_estimators=140; total time=   1.5s\n",
      "[CV] END model__criterion=entropy, model__max_depth=18, model__n_estimators=140; total time=   1.5s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=14, model__n_estimators=100; total time=   1.1s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=14, model__n_estimators=100; total time=   1.0s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=14, model__n_estimators=100; total time=   1.0s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=14, model__n_estimators=120; total time=   1.3s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=14, model__n_estimators=120; total time=   1.2s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=14, model__n_estimators=120; total time=   1.2s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=14, model__n_estimators=140; total time=   1.4s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=14, model__n_estimators=140; total time=   1.3s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=14, model__n_estimators=140; total time=   1.4s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=16, model__n_estimators=100; total time=   1.2s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=16, model__n_estimators=100; total time=   1.1s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=16, model__n_estimators=100; total time=   1.2s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=16, model__n_estimators=120; total time=   1.6s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=16, model__n_estimators=120; total time=   1.3s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=16, model__n_estimators=120; total time=   1.3s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=16, model__n_estimators=140; total time=   1.5s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=16, model__n_estimators=140; total time=   1.4s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=16, model__n_estimators=140; total time=   1.4s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=18, model__n_estimators=100; total time=   1.3s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=18, model__n_estimators=100; total time=   1.1s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=18, model__n_estimators=100; total time=   1.1s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=18, model__n_estimators=120; total time=   1.7s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=18, model__n_estimators=120; total time=   1.4s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=18, model__n_estimators=120; total time=   1.3s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=18, model__n_estimators=140; total time=   1.6s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=18, model__n_estimators=140; total time=   1.5s\n",
      "[CV] END model__criterion=log_loss, model__max_depth=18, model__n_estimators=140; total time=   1.5s\n"
     ]
    },
    {
     "data": {
      "text/html": [
       ...
       "    cursor: pointer;\n",
       "}\n",
       "</style><body><div id=\"sk-container-id-7\" class=\"sk-top-container\"><div class=\"sk-text-repr-fallback\"><pre>GridSearchCV(cv=3,\n",
       ...
       "        </a>\n",
       "    </td>\n",
       "            <td class=\"value\">{&#x27;model__criterion&#x27;: [&#x27;gini&#x27;, &#x27;entropy&#x27;, ...], &#x27;model__max_depth&#x27;: [14, 16, ...], &#x27;model__n_estimators&#x27;: [100, 120, ...]}</td>\n",
       "        </tr>\n",
       "    \n",
       "\n",
       "        <tr class=\"default\">\n",
       ...
       "            </details>\n",
       "        </div>\n",
       "    </div></div></div><div class=\"sk-parallel\"><div class=\"sk-parallel-item\"><div class=\"sk-item\"><div class=\"sk-label-container\"><div class=\"sk-label fitted sk-toggleable\"><input class=\"sk-toggleable__control sk-hidden--visually\" id=\"sk-estimator-id-26\" type=\"checkbox\" ><label for=\"sk-estimator-id-26\" class=\"sk-toggleable__label fitted sk-toggleable__label-arrow\"><div><div>best_estimator_: Pipeline</div></div></label><div class=\"sk-toggleable__content fitted\" data-param-prefix=\"best_estimator___\"></div></div><div class=\"sk-serial\"><div class=\"sk-item\"><div class=\"sk-serial\"><div class=\"sk-item\"><div class=\"sk-estimator fitted sk-toggleable\"><input class=\"sk-toggleable__control sk-hidden--visually\" id=\"sk-estimator-id-27\" type=\"checkbox\" ><label for=\"sk-estimator-id-27\" class=\"sk-toggleable__label fitted sk-toggleable__label-arrow\"><div><div>TfidfVectorizer</div></div><div><a class=\"sk-estimator-doc-link fitted\" rel=\"noreferrer\" target=\"_blank\" href=\"https://scikit-learn.org/1.8/modules/generated/sklearn.feature_extraction.text.TfidfVectorizer.html\">?<span>Documentation for TfidfVectorizer</span></a></div></label><div class=\"sk-toggleable__content fitted\" data-param-prefix=\"best_estimator___tfidf__\">\n",
       "        <div class=\"estimator-table\">\n",
       "            <details>\n",
       "                <summary>Parameters</summary>\n",
       "                <table class=\"parameters-table\">\n",
       ...
       "            </details>\n",
       "        </div>\n",
       "    </div></div></div><div class=\"sk-item\"><div class=\"sk-estimator fitted sk-toggleable\"><input class=\"sk-toggleable__control sk-hidden--visually\" id=\"sk-estimator-id-28\" type=\"checkbox\" ><label for=\"sk-estimator-id-28\" class=\"sk-toggleable__label fitted sk-toggleable__label-arrow\"><div><div>RandomForestClassifier</div></div><div><a class=\"sk-estimator-doc-link fitted\" rel=\"noreferrer\" target=\"_blank\" href=\"https://scikit-learn.org/1.8/modules/generated/sklearn.ensemble.RandomForestClassifier.html\">?<span>Documentation for RandomForestClassifier</span></a></div></label><div class=\"sk-toggleable__content fitted\" data-param-prefix=\"best_estimator___model__\">\n",
       "        <div class=\"estimator-table\">\n",
       "            <details>\n",
       "                <summary>Parameters</summary>\n",
       "                <table class=\"parameters-table\">\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 208,
   "id": "96ba8846-f565-46e6-9fb9-caa4bd1ed389",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 209,
   "id": "a44d97e4-1f40-49bc-a5a6-892b25798e6d",
   "metadata": {},
   "outputs": [
    {
     "data": {
      "text/plain": [
       "np.float64(0.8416666666666668)"
      ]
     },
     "execution_count": 209,
     "metadata": {},
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 210,
   "id": "d6a4fe2a-21e7-4ae4-ae5f-9b072325748f",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 211,
   "id": "f43d7ddc-a3d6-40e2-923e-12d7f9da9f9c",
   "metadata": {},
   "outputs": [],
   "source": [
    "df_sub['topic'] = y_pred"
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 212,
   "id": "229c308b-c993-4e15-b308-db29216ffc78",
   "metadata": {},
   "outputs": [],
   "source": [
    "df_sub.to_csv('base_submission_news.csv',index=False,index_label=False)"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 213,
   "id": "610835a4-d028-49f7-8c95-3f76f72802df",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "0a1d7082-f293-4897-9d5a-743c763074c1",
   "metadata": {},
   "outputs": [],
   "source": []
  }
